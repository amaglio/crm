            ...
            <div class="box box-primary">
              ...
              <div class="box-body ">
                <ul class="users-list clearfix">
                  ...
                  <?php  if( count($consultas_mis_programa) > 0 ): ?>
                            ...
                            <table  class="table search-result table-striped table-bordered" id="consultas_generales" cellspacing="0" width="100%">
                              ...
                              <tbody>
                                ...
                                <?php  for ($i=0; $i < count($consultas_mis_programa); $i++): ?>

                                <tr>
                                    <td><?=$consultas_mis_programa[$i]['consultas']->ID_CRM_CONSULTA?></td>

                                    <td><?=$consultas_mis_programa[$i]['consultas']->FECHA_CONSULTA?></td>
                                     <td><?=$consultas_mis_programa[$i]['consultas']->NOMBRE_APELLIDO?></td>
                                     <td>
                                        <?php

                                          $programas = explode("/", $consultas_mis_programa[$i]['consultas']->PROGRAMAS_INTERESADOS);
                                    ...
                                    <td>
                                        <a  data-toggle="tooltip" data-placement="bottom" data-original-title="Ir a la consulta" href="<?=base_url()?>index.php/consulta/ver_consulta/<?=$consultas_mis_programa[$i]['consultas']->ID_CRM_CONSULTA?>">
